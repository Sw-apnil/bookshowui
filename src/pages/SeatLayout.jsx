...
const SeatLayout = () => {
  ...
  // URL se show id aur date
  const { id, date } = useParams();

  // User ne kaun si seats select ki
  const [selectedSeats, setSelectedSeats] = useState([]);

  // User ne kaunsa time select kiya
  const [selectedTime, setSelectedTime] = useState(null);

  // Show ka data (movie + timings)
  ...
  // Page load hote hi show data lao
  useEffect(() => {
    getShow();
  }, []);
